...
using Quartz;
using WMS_3PL_IntegrationService.CodigoBarras.Jobs;
using Microsoft.Extensions.Configuration;
using System.IO;

namespace WMS_3PL_IntegrationService.CodigoBarras
{
                     ...
                     .ConfigureServices((hostContext, services) =>
                     {
                        ...
                        .AddJsonFile("appsettings.json", optional: true, reloadOnChange: true);
                         ...
                         services.AddQuartz(q =>
                         {
                             ...
                             var jobKey = new JobKey("CodigoBarrasJob");


                             q.AddJob<CodigoBarrasJob>(opts => opts.WithIdentity(jobKey));
